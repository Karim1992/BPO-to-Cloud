...
public class matrix5 extends JFrame {
    public static JTable table_transfer5;
    public static DefaultTableModel matrix5_transfer_model;
    public static JButton bouton5_validation_transfer;
  ...
  public matrix5() {
   ...
   ListModel lm = new AbstractListModel() {
    ...
    matrix5_transfer_model = new DefaultTableModel(lm.getSize(), 5) {
    ...
    */
    ...
    table_transfer5 = new JTable(matrix5_transfer_model);
 
        matrix5_transfer_model.setValueAt(0, 0, 0);
        matrix5_transfer_model.setValueAt(0, 1, 1);
        matrix5_transfer_model.setValueAt(0, 2, 2);
        matrix5_transfer_model.setValueAt(0, 3, 3);
        matrix5_transfer_model.setValueAt(0, 4, 4);
    ...
    matrix5_transfer_model.setColumnIdentifiers(titres_colonnes);
    JList rowHeader = new JList(lm);
    rowHeader.setFixedCellWidth(80);
    table_transfer5.setRowHeight(20);
    rowHeader.setFixedCellHeight(table_transfer5.getRowHeight());
    //    + table.getRowMargin());
    //                           + table.getIntercellSpacing().height);
    rowHeader.setCellRenderer(new RowHeaderRenderer(table_transfer5));

    JScrollPane scroll = new JScrollPane(table_transfer5);
   scroll.setRowHeaderView(rowHeader);
    this.setLayout(new BorderLayout());
    this.add(scroll, BorderLayout.CENTER);
    
   bouton5_validation_transfer = new JButton("Validate data transfer");
   getContentPane().add(bouton5_validation_transfer, BorderLayout.SOUTH);
...
/*   DefaultTableCellRenderer renderer = new DefaultTableCellRenderer();
  ...
  */  
    table_transfer5.setDefaultRenderer(Object.class, new ColorRenderer());
