...
public class matrix3 extends JFrame {
    public static JTable table_transfer3;
    public static DefaultTableModel matrix3_transfer_model;
    public static JButton bouton3_validation_transfer;
  ...
  public matrix3() {
   ...
   ListModel lm = new AbstractListModel() {
    ...
    matrix3_transfer_model = new DefaultTableModel(lm.getSize(), 3) {
    ...
    */
    ...
    table_transfer3 = new JTable(matrix3_transfer_model);
 
    //remplir la diagonale avec des 0 puisque une tâche ne peut pas être séparée d'elle même 
    matrix3_transfer_model.setValueAt(0, 0, 0);
    matrix3_transfer_model.setValueAt(0, 1, 1);
    matrix3_transfer_model.setValueAt(0, 2, 2);

      
    
    //table.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
    String titres_colonnes[] = { task_name1, task_name2, task_name3 };
    matrix3_transfer_model.setColumnIdentifiers(titres_colonnes);
    JList rowHeader = new JList(lm);
    rowHeader.setFixedCellWidth(90);
    table_transfer3.setRowHeight(25);
    rowHeader.setFixedCellHeight(table_transfer3.getRowHeight());
    //    + table.getRowMargin());
    //                           + table.getIntercellSpacing().height);
    rowHeader.setCellRenderer(new RowHeaderRenderer(table_transfer3));

    JScrollPane scroll = new JScrollPane(table_transfer3);
   scroll.setRowHeaderView(rowHeader);
    this.setLayout(new BorderLayout());
    this.add(scroll, BorderLayout.CENTER);
    
   bouton3_validation_transfer = new JButton("Validate data transfer");
   getContentPane().add(bouton3_validation_transfer, BorderLayout.SOUTH);
...
/*   DefaultTableCellRenderer renderer = new DefaultTableCellRenderer();
  ...
  */  
    table_transfer3.setDefaultRenderer(Object.class, new ColorRenderer());
